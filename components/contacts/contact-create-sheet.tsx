...
export function ContactCreateSheet({ triggerLabel = 'New contact', source = 'contacts:index', variant = 'solid', size = 'md' }: Props) {
    ...
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/80 px-4">
          <div className="w-full max-w-lg rounded-3xl border border-slate-700 bg-slate-900/95 p-6 text-slate-100 shadow-2xl">
